...
{
    Product* Item = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return Item;
...
{
    Product* Item = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return Item;
}
...
{
    Product* Item = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return Item;
